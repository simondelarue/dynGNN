...
class GCNModel(nn.Module):
    ...
    # Simplify training loop by removing negative sampling part
    # This is done to test a simpler PDAG structure
    def train_simplified(self, optimizer, predictor, loss, device, epochs, **kwargs):
