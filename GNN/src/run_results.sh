...
python3 s20c/main.py --data ia-enron-employees --feat_struct agg_simp --model GraphSage --epoch 1500 --lr 0.01 --timestep 20  --metric auc --test_agg True --duplicate_edges False --predictor dotProduct --loss_func BCEWithLogits
...
python3 s20c/main.py --data ia-enron-employees --feat_struct agg --model GraphConv --epoch 1500 --lr 0.01 --timestep 20 --metric auc --test_agg True --duplicate_edges False --predictor dotProduct --loss_func BCEWithLogits
...
20ython3 src/main.py --data ia-enron-employees --feat_struct agg --model GraphSage --epoch 1500 --lr 0.01 --timestep 20 --metric auc --test_agg True --duplicate_edges False --predictor dotProduct --loss_func BCEWithLogits
...
20python3 src/main.py --data ia-enron-employees --feat_struct temporal_edges --model GraphSage --epoch 700 --lr 0.01 --timestep 1 --metric auc --test_agg True --duplicate_edges False --predictor dotProduct --loss_func BCEWithLogits --step_prediction single
